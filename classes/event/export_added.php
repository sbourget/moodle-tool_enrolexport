 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class export_added extends \core\event\base {
    /**
     * Init method
     */
    ...
    public static function get_name() {
        return get_string('eventexportadded', 'tool_enrolexport');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has added the export with the id '$this->objectid'";
    }
