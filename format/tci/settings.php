...
if ($ADMIN->fulltree) {
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/student_firstname', get_string('student_firstname', 'enrolexporter_tci'),
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/student_lastname', get_string('student_lastname', 'enrolexporter_tci'),
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/student_username', get_string('student_username', 'enrolexporter_tci'),
        get_string('student_username_desc', 'enrolexporter_tci'), 'username', array(
            'username' => 'username',
            'email' => 'email'
        )));

    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/student_password', get_string('student_password', 'enrolexporter_tci'),
    ...
    // Not included: $firstteacher->email, $programcode, $classperiod
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/teacher_email', get_string('teacher_email', 'enrolexporter_tci'),
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/teacher_firstname', get_string('teacher_firstname', 'enrolexporter_tci'),
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/teacher_lastname', get_string('teacher_lastname', 'enrolexporter_tci'),
    ...
    $mysettings->add(new admin_setting_configselect('enrolexporter_tci/teacher_password', get_string('teacher_password', 'enrolexporter_tci'),
    ...
    // Not included: $teacher->confirmed, $programcode
}
